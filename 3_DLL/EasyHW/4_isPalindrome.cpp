...
public:
    ...
    {
        int i{0};
        for (Node *front{head}, *back{tail}; i < (length / 2 + length % 2); front = front->next, back = back->prev)
        {
