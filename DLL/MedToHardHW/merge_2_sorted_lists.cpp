...
class DllExt : public Dll {
  public:
	...
	void merge_2_sorted_lists(DllExt &other) {
...
void test_2nd_dll_is_smaller(void) {
	std::cout
		<< "=================Merge 2nd DllExt is small==================\n";
	DllExt dll1{6, 7, 8, 9, 10};
	std::cout << "First dll : " << dll1 << "\n";

	DllExt dll2{1, 2, 3, 4, 5};
...
void test_2nd_dll_is_bigger(void) {
	std::cout << "=================Merge 2nd DllExt is Big==================\n";
	DllExt dll1{1, 2, 3, 4, 5};
	std::cout << "First dll : " << dll1 << "\n";

	DllExt dll2{6, 7, 8, 9, 10};
	std::cout << "Second dll : " << dll2 << "\n";
...
void test_2nd_dll_with_elem_after_before_1st(void) {
	...
	std::cout
		<< "=================Test 2nd DllExt With Elements After and Before "
		   "1st==================\n";
	DllExt dll1{6, 7, 8, 9, 10};
	std::cout << "First dll : " << dll1 << "\n";

	DllExt dll2{2, 3, 4, 12, 14, 15};
	std::cout << "Second dll : " << dll2 << "\n";
...
void test_2nd_dll_shorter_than_1st(void) {
	std::cout << "=================Test 2nd DllExt Shorter than "
				 "1st=================\n";
	DllExt dll1{6, 7, 8, 9, 10};
	std::cout << "First dll : " << dll1 << "\n";
...
void test_1st_dll_shorter_than_2nd(void) {
	std::cout
		<< "=================Test 1st dll shorter than 2nd================\n";
	DllExt dll1{6, 7};
	std::cout << "First dll : " << dll1 << "\n";

	DllExt dll2{2, 3, 4, 9, 11, 13};
	std::cout << "Second dll : " << dll2 << "\n";
...
void test_course_example(void) {
	...
	DllExt dll1{10, 20, 30, 40, 50};
	std::cout << "First dll : " << dll1 << "\n";

	DllExt dll2{15, 17, 22, 24, 35};
	std::cout << "Second dll : " << dll2 << "\n";
