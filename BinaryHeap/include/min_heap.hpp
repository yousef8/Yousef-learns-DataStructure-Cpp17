#ifndef MIN_HEAP_20260418_HPP
#define MIN_HEAP_20260418_HPP
...
class MinHeap {
  public:
	MinHeap(int capacity = 1000)
		: size(0), capacity(capacity), arr(new int[capacity]) {}

	MinHeap(std::initializer_list<int> values) : MinHeap(values.size() + 1000) {
		size = values.size();
